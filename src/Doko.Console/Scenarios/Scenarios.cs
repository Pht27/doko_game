...
public static class Scenarios
{
    ...
    public static ScenarioConfig Schweinchen(int player = 0) => new()
    {
    ...
    public static ScenarioConfig Heidmann(int player = 0) => new()
    {
    ...
    public static ScenarioConfig Gehangter(int player = 0) => new()
    {
        Name = $"Links-/Rechtsgehängter (P{player} holds both ♦ Jacks)",
        PlayerRequiredCards = { [player] = [CT(Suit.Karo, Rank.Bube), CT(Suit.Karo, Rank.Bube)] }
    };

    /// <summary>P0 holds both ♥ Queens → eligible for Genscherdamen.</summary>
    public static ScenarioConfig Genscherdamen(int player = 0) => new()
    {
        Name = $"Genscherdamen (P{player} holds both ♥ Queens)",
        PlayerRequiredCards = { [player] = [CT(Suit.Herz, Rank.Dame), CT(Suit.Herz, Rank.Dame)] }
    };

    /// <summary>P0 holds both ♥ Jacks → eligible for Kemmerich (withdraw an announcement).</summary>
    public static ScenarioConfig Kemmerich(int player = 0) => new()
    {
        Name = $"Kemmerich (P{player} holds both ♥ Jacks)",
        PlayerRequiredCards = { [player] = [CT(Suit.Herz, Rank.Bube), CT(Suit.Herz, Rank.Bube)] }
    };

    /// <summary>P0 holds both ♥ Nines → eligible for Schatz. Requires PlayWithNines = true.</summary>
    public static ScenarioConfig Schatz(int player = 0) => new()
    {
        Name = $"Schatz (P{player} holds both ♥ Nines — needs PlayWithNines)",
        PlayerRequiredCards = { [player] = [CT(Suit.Herz, Rank.Neun), CT(Suit.Herz, Rank.Neun)] }
    };

    /// <summary>P0 holds both ♦ Aces AND both ♠ Jacks → eligible for Schweinchen + Heidmann.</summary>
    public static ScenarioConfig SchweinchenUndHeidmann(int player = 0) => new()
    {
        ...
        PlayerRequiredCards =
        {
            [player] =
            [
                CT(Suit.Karo, Rank.Ass),  CT(Suit.Karo, Rank.Ass),
                CT(Suit.Pik, Rank.Bube),  CT(Suit.Pik, Rank.Bube),
            ]
        }
    };
    ...
    /// </summary>
    public static ScenarioConfig Hochzeit(int player = 0) => new()
    {
        Name = $"Hochzeit (P{player} holds both ♣ Queens)",
        PlayerRequiredCards = { [player] = [CT(Suit.Kreuz, Rank.Dame), CT(Suit.Kreuz, Rank.Dame)] }
    };
    ...
    /// </summary>
    public static ScenarioConfig Armut(int player = 0) => new()
    {
        ...
        PlayerRequiredCards =
        {
            [player] =
            [
                CT(Suit.Kreuz, Rank.Ass),   CT(Suit.Kreuz, Rank.Ass),
                CT(Suit.Kreuz, Rank.Koenig), CT(Suit.Kreuz, Rank.Koenig),
                CT(Suit.Pik,   Rank.Ass),   CT(Suit.Pik,   Rank.Ass),
                CT(Suit.Pik,   Rank.Koenig), CT(Suit.Pik,   Rank.Koenig),
                CT(Suit.Herz,  Rank.Ass),   CT(Suit.Herz,  Rank.Ass),
                CT(Suit.Herz,  Rank.Koenig), CT(Suit.Herz,  Rank.Koenig),
            ]
        }
    };
    ...
    /// </summary>
    public static ScenarioConfig ManyBothPairs(int player = 0) => new()
    {
        ...
        PlayerRequiredCards =
        {
            [player] =
            [
                CT(Suit.Karo, Rank.Ass),  CT(Suit.Karo, Rank.Ass),   // Schweinchen
                CT(Suit.Herz, Rank.Dame), CT(Suit.Herz, Rank.Dame),   // Genscherdamen
                CT(Suit.Pik,  Rank.Bube), CT(Suit.Pik,  Rank.Bube),  // Heidmann
            ]
        }
    };
