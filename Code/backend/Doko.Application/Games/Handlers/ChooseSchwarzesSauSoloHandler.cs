    ...
    public Task<GameActionResult<ChooseSchwarzesSauSoloResult>> ExecuteAsync(
        ...
        GameCommandPipeline.RunAsync<ChooseSchwarzesSauSoloResult>(
            ...
            execute: state =>
            {
                ...
                state = state.Apply(new SetGameModeModification(reservation, command.Player));
                ...
                return (Ok(new ChooseSchwarzesSauSoloResult(null)), [], state);
            },
            ct
        );
